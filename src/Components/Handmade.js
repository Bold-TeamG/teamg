...
export default function Handmade() {
  ...
  const [Modal1, open1, close1] = useModal('root', {
    preventScroll: true,
    focusTrapOptions: {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        ...
        const q = query(postsCollection, where('is_handmade', '==', true));
        ...
        const postsWithThumbnailsAndIcons = await Promise.all(
  ...
  const View = ({ posts }) => { const openModal2 = () => {
          ...
          <div key={post.id} className="content">
              ...
              <div className="joboffer-container">
                <section className="joboffer-description">
                  ...
                  <div className="joboffer-input">
                    ...
                    <input type="text" placeholder="Job content" />
                ...
                <div className="joboffer-submitbutton">
                  ...
                  <button onClick={close1}>Back</button>
                </div>
              </div>
            </Modal1>
            <div className="video-container">
              ...
              <div className="icons">
                ...
                />
               <svg className="star-icon icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="-0.5 -0.5 30 30" height="30" width="30" id="Volunteer-Activism-Fill--Streamline-Rounded-Fill---Material-Symbols" onClick={open1}>
              ...
              <div className="under-box">
                ...
                <div className="recoms">
                  <div className="comp-each" onClick={openModal2}>
                    <img
                      src={post.img_url}
                      alt="Item"
                  ...
                  {isModal2Open && (
                    <div className="js-modal__bg" onClick={closeModal2}>
                
                      <div
                        className={`js-modal__main ${isAnimating2 ? '_slideUp' : '_slideDown'}`}
                        onClick={(e) => e.stopPropagation()}
                      >
                        <button className="js-modal__btn--close" onClick={closeModal2}>
                        ×
                        </button>
                        <ProductComponent product_id={post.product_id} />
                      
                      </div>
                    </div>
                  )}

                    <div className="comp-each" onClick={openModal3}>
                      <img
                        src={post.goods_url}
                        alt="Item"
                        className="item-icon side-item"
                    ...
                    {isModal3Open && (
                    <div className="js-modal__bg" onClick={closeModal3}>
                    ...
                    <div className="comp-each" onClick={openModal4}>
                      <img
                        src={post.genre_url}
                        alt="Item"
                        className="item-icon side-item"
                    ...
                    {isModal4Open && (
                    <div className="js-modal__bg" onClick={closeModal4}>
                      
                      <div
                        className={`js-modal__main ${isAnimating4 ? '_slideUp' : '_slideDown'}`}
                        onClick={(e) => e.stopPropagation()}
                      >
                        <button className="js-modal__btn--close" onClick={closeModal4}>
                          ×
                        </button>
                        <GenreComponent genre_id={post.genre_id} />
